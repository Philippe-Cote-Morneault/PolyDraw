...
class CoopMatchFragment : TutorialSlideFragment(R.string.tutorial_slide_coop_match_title) {
    override fun onCreateView(
        ...
        val root = inflater.inflate(R.layout.fragment_tutorial_slide_coop_match, container, false)
        return root
    }

    override fun onResume() {
        super.onResume()
        (activity as TutorialActivity).setSlideTitle(R.string.tutorial_slide_coop_match_title)
    }
}