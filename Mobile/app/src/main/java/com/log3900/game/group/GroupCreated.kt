...
class GroupCreated(var groupName: String?, var playersMax: Int, var virtualPlayers: Int, var gameType: MatchMode, var difficulty: Difficulty?, var language: Language) {
