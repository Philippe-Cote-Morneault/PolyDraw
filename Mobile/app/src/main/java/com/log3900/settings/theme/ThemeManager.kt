...
class ThemeManager {
    companion object {
        ...
        var themes: ArrayList<Theme> = arrayListOf(
            Theme(0, R.style.MyTheme_IndigoOrange, R.drawable.indigo_orange_theme_button, R.string.theme_indigo_orange_title),
            Theme(1, R.style.MyTheme_BlueYellow, R.drawable.blue_yellow_theme_button, R.string.theme_blue_yellow_title),
            Theme(2, R.style.MyTheme_BrownGreen, R.drawable.brown_green_theme_button, R.string.theme_brown_green_title),
            Theme(3, R.style.MyTheme_GreenTeal, R.drawable.green_teal_theme_button, R.string.theme_green_teal_title),
