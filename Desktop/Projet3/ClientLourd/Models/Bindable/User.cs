    ...
    public class User : ModelBase
    {
        ...
        public bool IsCPU
        {
            ...
            set
            {
                if (value != _isCPU)
                {
                    ...
                    if (_isCPU)
                    {
                        _avatar = new BitmapImage(new Uri($"/ClientLourd;component/Resources/robot.png",
                            UriKind.Relative));
                    }
        ...
        public int PictureID
        {
            ...
            set
            {
                ...
                {
                    _pictureID = value;
                    _avatar = new BitmapImage(new Uri($"/ClientLourd;component/Resources/Avatar/{_pictureID}.jpg",
                        UriKind.Relative));
                    NotifyPropertyChanged();
